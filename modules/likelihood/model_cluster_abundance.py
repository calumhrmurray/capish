...
class ClusterAbundance():
    ...
    def Cluster_SurfaceDensity_ProxyZ(self, bins, integrand_count = None, grids = None, is_there_purity = True): 
    ...
    def Cluster_NHMFLogSlope_ProxyZ(self, bins, integrand_count = None, log_slope = None, grids = None, cosmo = None):
