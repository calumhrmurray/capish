...
class Universe_simulation:
    ...
    def run_simulation(self, param_values):
        ...
        richness, log10M_wl, z_clusters = self._run_simulation( full_parameter_set )
    ...
    def _run_simulation(self, full_parameter_set ):
        ...
        # add observational errors to the lensing masses
        #sigma_log10M_wl = 

        # Apply selection function
        selection = richness > self.selection_richness
        return richness[selection], log10M_wl[selection], z_clusters[selection] #, sigma_log10M_wl[selection]
