...
CONFIG=selection_bias_default_corrected
...
# python sbi_run_simulations.py --config_to_simulate DESlike6_corrected_narrow_prior_1_param --seed 30 --n_sims 1000 --checkpoint_interval 10 --n_cores 3
