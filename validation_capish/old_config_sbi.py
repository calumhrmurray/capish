...
for i in range(3):
    ...
    if i==2:
        ...
        config_new['name'] = 'DESlike_MoR_log10Mwl_stacked_scatter_standard_prior_6_params'
    else:
        config_new["name"] = 'DESlike_MoR_log10Mwl_stacked_scatter' + config_list[i]['name'].split('baseline')[1]
    new_config_list.append(config_new)
...
for k in config_dict.keys():
    ...
    if k == 'DESlike_MoR_log10Mwl_stacked_scatter_standard_prior_6_params':
...
#python sbi_sample_posteriors.py --config_to_sample DESlike_MoR_log10Mwl_stacked_scatter_standard_prior_6_params
