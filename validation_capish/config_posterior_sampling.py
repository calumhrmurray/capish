...
config_sampling_4 = {"name":'power_law_log10Mwl_standard_prior_5_params',
                     "data_vector_infos": "flagship_like_sim",
                     "config_sbi" : 'power_law_log10Mwl_standard_prior_5_params',
                     "data_vector_count" :count,
                     "data_vector_log10mass" : log10mass,}

data = load_pickle('../../capish_sbi_data/config_sbi_power_law_log10Mwl_no_scatter_narrow_prior_1_param/simulations.pkl')
count =  np.mean(data['x'][0], axis=0) 
log10mass = np.mean(data['x'][1], axis=0)

config_sampling_5 = {"name":'power_law_log10Mwl_no_scatter_standard_prior_5_params',
                     "data_vector_infos": "flagship_like_sim",
                     "config_sbi" : 'power_law_log10Mwl_no_scatter_standard_prior_5_params',
                     "data_vector_count" :count,
                     "data_vector_log10mass" : log10mass,}

data = load_pickle('../../capish_sbi_data/config_sbi_power_law_log10Mwl_stacked_scatter_narrow_prior_1_param/simulations.pkl')
count =  np.mean(data['x'][0], axis=0) 
log10mass = np.mean(data['x'][1], axis=0)

config_sampling_6 = {"name":'power_law_log10Mwl_stacked_scatter_standard_prior_5_params',
                     "data_vector_infos": "flagship_like_sim",
                     "config_sbi" : 'power_law_log10Mwl_stacked_scatter_standard_prior_5_params',
                     "data_vector_count" :count,
                     "data_vector_log10mass" : log10mass,}

config_list=[config_sampling_1,config_sampling_2,config_sampling_3,config_sampling_4,config_sampling_5,config_sampling_6]

config_dict = {config['name']: config for config in config_list}

#python sbi_sample_posteriors.py --config_to_sample power_law_log10Mwl_stacked_scatter_standard_prior_5_params