...
cfg_ini_new['parameters']['beta_lambda'] = '1.72'
cfg_ini_new['parameters']['gamma_lambda'] = '0.0'
cfg_ini_new['halo_catalogue']['hmf_name'] = 'Tinker08'
...
for i in range(3):
    ...
    if i==2:
        ...
        config_new['config_simulation']["prior_max"] = [0.45, 0.95, 
                                                        4.0, 2.1, 
                                                        0.7, 0.5]
        config_new['name'] = 'DESlike6_TK08_corrected_standard_prior_6_params'
    else:
        config_new["name"] = 'DESlike6_TK08_corrected' + config_list[i]['name'].split('baseline')[1]
    new_config_list.append(config_new)
