...
def sample_posterior():
    ...
    save_dir = f'./config_sbi_{config_sbi_file["name"]}/'
    load_dir = f'./config_sbi_{config_sbi_file["name"]}/'
    ...
    log10mass = count * config_sampling["data_vector_log10mass"].reshape(-1)
    ...
    post = [posterior_count, 
            posterior_Nlog10mass, posterior_Nmass, 
            posterior_count_Nlog10mass, posterior_count_Nmass]
    
    label =  ['count', 
              'Nlog10m', 'Nm', 
              'count_Nlog10m','count_Nm']
